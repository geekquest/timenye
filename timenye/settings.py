"""
Django settings for timenye project.
...
SECRET_KEY = 'django-insecure-c61x0#i!rl^+zru6cajg@m4ruf)2e9@^_7x=^(^#wr(xh$dbco'
...
DATABASES = {
    'default': {
        ...
        'USER': 'timenye',      # Your database user (e.g., 'postgres')
        'PASSWORD': 'timenye123',   # The password you set (e.g., 'Lunar123#')
